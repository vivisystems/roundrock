...
var nsDefaultCLH = {
  ...
  handle : function clh_handle(cmdLine) {
    ...
    try {
      singletonWindowType = cmdLine.handleFlagWithParam("singleton", false);

      if (singletonWindowType) {
          var windowMediator =
    ...
    try {
      ...
      chromeURI = cmdLine.handleFlagWithParam("chrome", false);
      if (!chromeURI) return ;
      ...
      var new_flags = cmdLine.handleFlagWithParam("flags", false);
      if (new_flags) flags = new_flags;
...
const clh_contractID = "@firich.com.tw/default-clh;1";
const clh_CID = Components.ID("{e79d9d68-9a1f-45a7-b5a0-b825daf02135}");
