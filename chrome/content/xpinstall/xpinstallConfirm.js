//@line 37 "/build/buildd/xulrunner-1.9-1.9.0.1+build1+nobinonly/mozilla/toolkit/mozapps/xpinstall/content/xpinstallConfirm.js"
...
XPInstallConfirm.init = function ()
{
  ...
  var _installCountdownLength = 0;
  var _installSigned = false;
  try {
  ...
  for (var i = 0; i < numItemsToInstall; ++i) {
	...
	_installSigned = cert ? true : false; 
  }
  ...
  _installSigned = true;
  _installCountdownLength = 0;
  if (!_installSigned) {
  	okButton.label = "uncerted";
	okButton.disabled = true;
  }
  else {
