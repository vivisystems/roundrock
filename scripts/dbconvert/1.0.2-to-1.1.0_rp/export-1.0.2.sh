...
VIVIPOS_UPGRADE_SCRIPT=vivipos.upg
...
cp ./${VIVIPOS_UPGRADE_SCRIPT} ${UPGRADE_DIR}
...
# create rp new tables in vivipos
echo
echo 'creating rp new tables in vivipos...'
${SQLBIN} ${UPGRADE_DIR}/vivipos.sqlite < ${UPGRADE_DIR}/${VIVIPOS_UPGRADE_SCRIPT}
