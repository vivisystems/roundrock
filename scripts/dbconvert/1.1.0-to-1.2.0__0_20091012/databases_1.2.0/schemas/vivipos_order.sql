CREATE TABLE "cashdrawer_records" ("id" VARCHAR PRIMARY KEY  NOT NULL ,"terminal_no" VARCHAR,"drawer_no" INTEGER,"clerk" VARCHAR,"clerk_displayname" VARCHAR,"event_type" VARCHAR,"status" INTEGER,"created" INTEGER,"modified" INTEGER,"payment_type" VARCHAR,"amount" FLOAT,"sequence" VARCHAR, "order_id" VARCHAR);
CREATE TABLE "clock_stamps" ("id" VARCHAR PRIMARY KEY  NOT NULL ,"username" VARCHAR,"clockin" BOOL,"job" VARCHAR,"clockout" BOOL,"clockin_time" VARCHAR,"created" INTEGER,"modified" INTEGER,"clockout_time" VARCHAR,"displayname" VARCHAR, "branch_id" VARCHAR);
...
CREATE TABLE "order_item_taxes" ("id" VARCHAR PRIMARY KEY  NOT NULL ,"order_id" VARCHAR NOT NULL ,"order_item_id" VARCHAR,"promotion_id" VARCHAR,"tax_no" VARCHAR NOT NULL ,"tax_name" VARCHAR NOT NULL ,"tax_type" VARCHAR NOT NULL ,"tax_rate" FLOAT NOT NULL ,"tax_rate_type" VARCHAR NOT NULL ,"tax_threshold" FLOAT NOT NULL ,"tax_subtotal" FLOAT,"included_tax_subtotal" FLOAT,"item_count" INTEGER DEFAULT 0 ,"taxable_amount" FLOAT DEFAULT 0 );
CREATE TABLE "order_items" ("id" VARCHAR PRIMARY KEY  NOT NULL ,"order_id" VARCHAR,"cate_no" VARCHAR,"included_tax" FLOAT, "cate_name" VARCHAR ,"product_no" VARCHAR,"product_barcode" VARCHAR,"product_name" VARCHAR,"current_qty" FLOAT,"current_price" FLOAT,"current_subtotal" FLOAT,"tax_name" VARCHAR,"tax_rate" FLOAT,"tax_type" VARCHAR,"current_tax" FLOAT,"discount_name" VARCHAR,"discount_rate" FLOAT,"discount_type" VARCHAR,"current_discount" FLOAT,"surcharge_name" VARCHAR,"surcharge_rate" FLOAT,"surcharge_type" VARCHAR,"current_surcharge" FLOAT,"condiments" VARCHAR,"current_condiment" FLOAT,"memo" TEXT,"has_discount" BOOL,"has_surcharge" BOOL,"has_marker" BOOL,"created" INTEGER,"modified" INTEGER, "destination" VARCHAR, "parent_no" VARCHAR, "weight" FLOAT DEFAULT 0, "sale_unit" VARCHAR DEFAULT 'unit', "seat_no" VARCHAR, "parent_index" VARCHAR, "has_setitems" BOOLEAN DEFAULT 0, "stock_maintained" BOOLEAN);
...
CREATE TABLE "order_payments" ("id" VARCHAR PRIMARY KEY  NOT NULL ,"order_id" VARCHAR,"order_items_count" INTEGER,"order_total" FLOAT,"name" VARCHAR,"amount" FLOAT,"memo1" TEXT,"memo2" TEXT,"created" INTEGER,"modified" INTEGER,"origin_amount" FLOAT,"service_clerk" VARCHAR,"proceeds_clerk" VARCHAR,"service_clerk_displayname" VARCHAR,"proceeds_clerk_displayname" VARCHAR,"change" FLOAT, "sale_period" INTEGER, "shift_number" INTEGER, "terminal_no" VARCHAR, "is_groupable" BOOL DEFAULT 0);
CREATE TABLE "order_promotions" ("id" VARCHAR PRIMARY KEY  NOT NULL ,"order_id" VARCHAR,"promotion_id" VARCHAR,"name" VARCHAR,"code" VARCHAR,"alt_name1" VARCHAR,"alt_name2" VARCHAR,"trigger" VARCHAR,"trigger_name" VARCHAR,"trigger_label" VARCHAR,"type" VARCHAR,"type_name" VARCHAR,"type_label" VARCHAR,"matched_amount" INTEGER,"matched_items_qty" INTEGER,"matched_items_subtotal" FLOAT,"discount_subtotal" FLOAT,"tax_name" VARCHAR,"current_tax" FLOAT,"included_tax" FLOAT, "created" INTEGER, "modified" INTEGER);
...
CREATE TABLE "order_receipts" ("id" VARCHAR PRIMARY KEY  NOT NULL ,"order_id" VARCHAR,"sequence" VARCHAR,"device" INTEGER,"created" INTEGER,"modified" INTEGER,"batch" INTEGER);
CREATE TABLE "orders" ("id" VARCHAR PRIMARY KEY  NOT NULL ,"sequence" VARCHAR,"items_count" INTEGER,"total" FLOAT,"change" FLOAT,"tax_subtotal" FLOAT,"surcharge_subtotal" FLOAT,"discount_subtotal" FLOAT,"payment_subtotal" FLOAT,"rounding_prices" VARCHAR,"precision_prices" VARCHAR,"rounding_taxes" VARCHAR,"precision_taxes" VARCHAR,"status" INTEGER,"service_clerk" VARCHAR,"service_clerk_displayname" VARCHAR,"proceeds_clerk" VARCHAR,"proceeds_clerk_displayname" VARCHAR,"member" VARCHAR,"member_displayname" VARCHAR,"member_email" VARCHAR,"member_cellphone" VARCHAR,"invoice_type" VARCHAR,"invoice_title" VARCHAR,"invoice_no" VARCHAR,"invoice_count" INTEGER,"destination" VARCHAR,"table_no" INTEGER,"check_no" INTEGER,"no_of_customers" INTEGER,"terminal_no" VARCHAR,"transaction_created" INTEGER,"transaction_submitted" INTEGER,"created" INTEGER,"modified" INTEGER,"included_tax_subtotal" FLOAT,"item_subtotal" FLOAT,"sale_period" INTEGER,"shift_number" INTEGER,"branch_id" VARCHAR,"branch" VARCHAR,"transaction_voided" INTEGER,"promotion_subtotal" FLOAT,"void_clerk" VARCHAR,"void_clerk_displayname" VARCHAR,"void_sale_period" INTEGER,"void_shift_number" INTEGER,"revalue_subtotal" FLOAT DEFAULT 0 ,"qty_subtotal" INTEGER DEFAULT 0 ,"inherited_order_id" VARCHAR,"inherited_desc" VARCHAR, "item_surcharge_subtotal" FLOAT DEFAULT 0, "trans_surcharge_subtotal" FLOAT DEFAULT 0, "item_discount_subtotal" FLOAT DEFAULT 0, "trans_discount_subtotal" FLOAT DEFAULT 0);
...
CREATE TABLE "shift_changes" ("id" VARCHAR,"starttime" INTEGER,"endtime" INTEGER,"balance" FLOAT,"note" VARCHAR,"created" INTEGER,"modified" INTEGER,"terminal_no" VARCHAR,"sale_period" INTEGER,"shift_number" INTEGER,"cash" FLOAT,"sales" FLOAT,"excess" FLOAT,"ledger_in" FLOAT, "ledger_out" FLOAT, "deposit" FLOAT, "refund" FLOAT, "credit" FLOAT, "reported_cash" FLOAT);
CREATE TABLE "shift_markers" ("id" VARCHAR PRIMARY KEY  NOT NULL ,"sale_period" INTEGER,"shift_number" INTEGER,"end_of_period" BOOL,"created" INTEGER,"modified" INTEGER, "terminal_no" VARCHAR, "end_of_shift" BOOL, "end_of_shift_cash" VARCHAR);
...
CREATE TABLE "uniform_invoices" ( "id" VARCHAR PRIMARY KEY  NOT NULL , "order_id" VARCHAR NOT NULL , "code" VARCHAR NOT NULL , "start_seq" VARCHAR NOT NULL , "end_seq" VARCHAR NOT NULL , "terminal_no" VARCHAR NOT NULL , "uniform_business_number" VARCHAR , "status" INTEGER , "sale_period" INTEGER , "shift_number" INTEGER ,"created" INTEGER ,"modified" INTEGER, "memo" VARCHAR, "reset_time" INTEGER, "manual" BOOL DEFAULT 0);
...
CREATE INDEX "order_item_condiments_oid" ON "order_item_condiments" ("order_id" ASC);
CREATE INDEX "order_item_taxes_oid" ON "order_item_taxes" ("order_id" ASC);
...
CREATE INDEX "order_member" ON "orders" ("member" ASC);
...
CREATE INDEX "order_payments_sp_tn_sn" ON "order_payments" ("sale_period" ASC, "terminal_no" ASC, "shift_number" ASC);
CREATE INDEX "order_promotions_oid" ON "order_promotions" ("order_id" ASC);
CREATE INDEX "order_queues_mode_status_user" ON "order_queues" ("mode" ,"status", "user");
CREATE INDEX "order_receipts_oid_device_batch" ON "order_receipts" ("order_id" ASC, "device" ASC, "batch" ASC);
CREATE INDEX "order_receipts_order_id" ON "order_receipts" ("order_id" ASC);
CREATE INDEX "orders_check_no" ON "orders" ("check_no" ASC);
...
CREATE INDEX "orders_table_no" ON "orders" ("table_no" ASC);
CREATE INDEX "orders_terminal_no" ON "orders" ("terminal_no" ASC);
CREATE INDEX "shift_change_details_scid" ON "shift_change_details" ("shift_change_id" ASC);
...
CREATE INDEX "uniform_invoices_oid" ON "uniform_invoices" ("order_id" ASC);
CREATE INDEX "uniform_invoices_sale_period" ON "uniform_invoices" ("sale_period" ASC);
CREATE INDEX "uniform_invoices_shift_number" ON "uniform_invoices" ("shift_number" ASC);
CREATE INDEX "uniform_invoices_terminal_no" ON "uniform_invoices" ("terminal_no" ASC);
