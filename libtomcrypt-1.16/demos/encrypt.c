...
strcpy(tmpkey, "11690b09f16021ff06a6857d784a1870cfd7e7f973e70926aad0d625bdd46a575e4d614d1c5e99716f23462a4e6aba4d348f55aad6891f02efb6d083f4a435ce");

//   printf("\nEnter key: ");
//   fgets((char *)tmpkey,sizeof(tmpkey), stdin);
//if(strstr(tmpkey, "\n")) {
//	char *p = strstr(tmpkey, "\n");
//        *p = '\0';
//} 
