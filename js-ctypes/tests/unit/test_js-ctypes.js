...
function run_test()
{
  ...
  var structify = library.declare("structify", Types.SYSV, Types.BOOL, POINT);
  var foo = new POINT(10, 10);
  do_check_eq(structify(foo), true);
...
function run_struct_tests(library) {
  var test_pt_in_rect = library.declare("test_pt_in_rect", Types.SYSV, Types.INT32, Types.INT32, Types.INT32, Types.INT32, Types.INT32, Types.INT32, Types.INT32);
  do_check_eq(test_pt_in_rect(5, 5, 10, 10, 6, 6), 1);
  do_check_eq(test_pt_in_rect(5, 5, 10, 10, 2, 2), 0);
}
