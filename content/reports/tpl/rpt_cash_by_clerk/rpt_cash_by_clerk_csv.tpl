...
"${_( '(rpt)Sale Period' )}","${_( '(rpt)Shift' )}","${_( '(rpt)Balance' )}","${_( '(rpt)Cash' )}","${_( '(rpt)Net Sales' )}","${_( '(rpt)Giftcard Excess' )}","${_( '(rpt)Deposit' )}","${_( '(rpt)Refund' )}","${_( '(rpt)Credit' )}","${_( '(rpt)Ledger In' )}","${_( '(rpt)Ledger Out' )}"
