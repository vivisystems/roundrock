...
"","${orders.terminal_no}","${orders.time|unixTimeToString}","${orders.sequence}","${orders.text}","${orders.item_subtotal|viviFormatPrices:true}","${orders.tax_subtotal|viviFormatPrices:true}","${orders.surcharge_subtotal|viviFormatPrices:true}","${orders.discount_subtotal|viviFormatPrices:true}","${orders.promotion_subtotal|viviFormatPrices:true}","${orders.revalue_subtotal|viviFormatPrices:true}","${orders.total|viviFormatPrices:true}"
{/for}
