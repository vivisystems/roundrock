...
${'  ' + _( '(rpt)Add-on Tax' ) + ':'|left:18}${orders.tax_subtotal|viviFormatPrices:true|right:24}
...
${'  ' + _( '(rpt)Add-on Tax' ) + ':'|left:18}${types.summary.tax_subtotal|viviFormatPrices:true|right:24}
