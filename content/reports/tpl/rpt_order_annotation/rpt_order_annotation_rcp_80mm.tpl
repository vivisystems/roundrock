...
${'  ' + _( '(rpt)Gross' ) + ':'|left:18}${order.item_subtotal|viviFormatPrices:true|right:24}
...
${'  ' + _( '(rpt)Net Sales' ) + ':'|left:18}${order.total|viviFormatPrices:true|right:24}
...
------------------------------------------
${_( '(rpt)Summary' )}
${'  ' + _( '(rpt)Gross' ) + ':'|left:18}${types.summary.item_subtotal|viviFormatPrices:true|right:24}
...
${'  ' + _( '(rpt)Net Sales' ) + ':'|left:18}${types.summary.total|viviFormatPrices:true|right:24}
