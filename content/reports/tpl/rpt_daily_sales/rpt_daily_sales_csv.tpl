...
"${_( 'Term_No.' )}","${_( 'Service Clerk' )}","${_( 'Proceeds Clerk' )}","${_( 'Time' )}","${_( 'Sequence' )}","${_( 'Total' )}","${_( 'Add-on Tax' )}","${_( 'Surcharge' )}","${_( 'Discount' )}","${_( 'Payment' )}","${_( 'Cash' )}","${_( 'Check' )}","${_( 'Credit Card' )}","${_( 'Coupon' )}","${_( 'Gift Card' )}"
{for detail in body}
