...
{/eval}
"${_( '(rpt)Records Found' ) + ':'}","${detail.orders.length}","","","","","","${_( '(rpt)Summary' ) + ':'}","${detail.summary.guests}","${detail.summary.items}","${detail.summary.item_subtotal|default:0|viviFormatPrices:true}","${detail.summary.tax_subtotal|default:0|viviFormatTaxes:true}","${detail.summary.surcharge_subtotal|default:0|viviFormatPrices:true}","${detail.summary.discount_subtotal|default:0|viviFormatPrices:true}","${detail.summary.promotion_subtotal|default:0|viviFormatPrices:true}","${detail.summary.revalue_subtotal|default:0|viviFormatPrices:true}","${detail.summary.total|default:0|viviFormatPrices:true}","${detail.summary.payment|default:0|viviFormatPrices:true}","${detail.summary.cash|default:0|viviFormatPrices:true}","${detail.summary.check|default:0|viviFormatPrices:true}","${detail.summary.creditcard|default:0|viviFormatPrices:true}","${detail.summary.coupon|default:0|viviFormatPrices:true}","${detail.summary.giftcard|default:0|viviFormatPrices:true}"
{/for}
