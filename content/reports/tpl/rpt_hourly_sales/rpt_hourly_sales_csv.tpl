...
{if head.terminal_no}"${_( '(rpt)Terminal' )}",{/if}"${_( '(rpt)Date' )}","${_( '(rpt)Hour' )}","${_( '(rpt)Net Sales' )}","${_( '(rpt)Orders' )}","${_( '(rpt)Guests' )}","${_( '(rpt)Items' )}","${_( '(rpt)Net Per Guest' )}","${_( '(rpt)Net Per Order' )}"
{for detail in body}
