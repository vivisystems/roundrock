...
"","${_( '(rpt)Revenue/Order' ) + ':'}","${body.sales_summary.AvgTotal|default:0|format:2}"
"","${_( '(rpt)Revenue/Guest' ) + ':'}","${body.sales_summary.AvgTotalPerGuest|default:0|format:2}"
"","${_( '(rpt)Guest/Order' ) + ':'}","${body.sales_summary.AvgGuests|default:0|format:2}"
"","${_( '(rpt)Item/Order' ) + ':'}","${body.sales_summary.AvgItemsCount|default:0|format:2}"
"",""
"${_( '(rpt)Payment List' )}"
