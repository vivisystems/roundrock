...
"","${_( '(rpt)Net Sales' )}","${body.sales_summary.NetSales|default:0|viviFormatPrices:true}"
"",""
"${_( '(rpt)Sales Summary' )}"
...
"","${_( '(rpt)Net Sales' ) + ':'}","${body.sales_summary.NetSales|default:0|viviFormatPrices:true}"
"","${_( '(rpt)Net Sales/Order' ) + ':'}","${body.sales_summary.AvgNetSales|default:0|viviFormatPrices:true}"
"","${_( '(rpt)Net Sales/Guest' ) + ':'}","${body.sales_summary.AvgNetSalesPerGuest|default:0|viviFormatPrices:true}"
