...
${'  ' + _( '(rpt)Average Total' ) + ':'|left:16}${body.sales_summary.AvgTotal|default:0|viviFormatPrices:true|right:26}
${'  ' + _( '(rpt)Average Guest' ) + ':'|left:16}${body.sales_summary.AvgGuests|default:0|viviFormatPrices:true|right:26}
${'  ' + _( '(rpt)Average Items' ) + ':'|left:16}${body.sales_summary.AvgItemsCount|default:0|viviFormatPrices:true|right:26}
------------------------------------------
${_( '(rpt)Payment List' )}
