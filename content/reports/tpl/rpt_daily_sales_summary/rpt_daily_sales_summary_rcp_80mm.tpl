...
${'    ' + _( '(rpt)Gross' ) + ':'|left:17}${detail.item_subtotal|default:0|viviFormatPrices:true|right:24}
...
${'    ' + _( '(rpt)Gross' ) + ':'|left:17}${foot.foot_datas.item_subtotal|default:0|viviFormatPrices:true|right:24}
