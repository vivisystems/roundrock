...
{for clerk in body}
${clerk.name}
"${_( '(rpt)Term_No.' )}","${_( clerk.associated_clerk )}","${_( '(rpt)Time' )}","${_( '(rpt)rpt_sequence' )}","${_( '(rpt)Total' )}","${_( '(rpt)Add-on Tax' )}","${_( '(rpt)Surcharge' )}","${_( '(rpt)Discount' )}","${_( '(rpt)Payment' )}","${_( '(rpt)Cash' )}","${_( '(rpt)Check' )}","${_( '(rpt)Credit Card' )}","${_( '(rpt)Coupon' )}","${_( '(rpt)Gift Card' )}"
