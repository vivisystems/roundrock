(function(){
    ...
    GeckoJS.Controller.extend( {
        ...
        execute: function() {
            ...
            var path = GREUtils.File.chromeToPath("chrome://viviecr/content/reports/tpl/Chinese/rpt_daily_sales_summary.tpl");
        ...
        exportRcp: function() {
            try {
                ...
                var path = GREUtils.File.chromeToPath("chrome://viviecr/content/reports/tpl/tpl_58mm/rpt_daily_sales_summary_rcp.tpl");
