(function(){
    ...
    GeckoJS.Controller.extend( {
        ...
        execute: function() {
            ...
            var path = GREUtils.File.chromeToPath("chrome://viviecr/locale/reports/tpl/rpt_daily_sales_summary/rpt_daily_sales_summary.tpl");
        ...
        exportCsv: function() {
            try {
                ...
                var path = GREUtils.File.chromeToPath("chrome://viviecr/locale/reports/tpl/rpt_daily_sales_summary/rpt_daily_sales_summary_csv.tpl");
        ...
        exportRcp: function() {
            try {
                ...
                var path = GREUtils.File.chromeToPath("chrome://viviecr/locale/reports/tpl/rpt_daily_sales_summary/rpt_daily_sales_summary_rcp_80mm.tpl");
