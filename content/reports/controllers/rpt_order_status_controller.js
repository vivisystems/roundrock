    ...
    GeckoJS.Controller.extend( {
       ...
       _showWaitPanel: function(panel, sleepTime) {
        ...
        execute: function() {
            ...
            var path = GREUtils.File.chromeToPath("chrome://viviecr/content/reports/tpl/Chinese/rpt_order_status.tpl");
        ...
        exportRcp: function() {
            try {
                ...
                var path = GREUtils.File.chromeToPath("chrome://viviecr/content/reports/tpl/tpl_58mm/rpt_order_status_rcp.tpl");
