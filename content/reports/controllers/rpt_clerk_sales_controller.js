    ...
    GeckoJS.Controller.extend( {
       ...
       _showWaitPanel: function( panel, sleepTime ) {
        ...
        execute: function() {
            ...
            var path = GREUtils.File.chromeToPath("chrome://viviecr/locale/reports/tpl/rpt_clerk_sales/rpt_clerk_sales.tpl");
        ...
        exportCsv: function() {
            try {
                ...
                var path = GREUtils.File.chromeToPath("chrome://viviecr/locale/reports/tpl/rpt_clerk_sales/rpt_clerk_sales_csv.tpl");
        ...
        exportRcp: function() {
            try {
                ...
                var path = GREUtils.File.chromeToPath("chrome://viviecr/locale/reports/tpl/rpt_clerk_sales/rpt_clerk_sales_rcp_80mm.tpl");
