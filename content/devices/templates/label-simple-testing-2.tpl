...
D11
H15
1A2102500600005${item.barcode}[&CR]
...
190000200060065${myModifiers.decimal(item.price_level1)|right:10}[&CR]
190000200060066${myModifiers.decimal(item.price_level1)|right:10}[&CR]
