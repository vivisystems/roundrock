...
[&ESC @][&ESC QA]MOD ${itemDisplay.no|right:16}[&CR]
{else}
...
[&ESC @][&ESC QA]${'Discount'|left:9} ${txn.formatPrice(item.current_discount)|right:10}[&CR]
[&ESC QB]TAL: ${txn.formatPrice(order.total)|right:15}[&CR]
{elseif type == 'afterAddSurcharge'}
[&ESC @][&ESC QA]${'Surcharge|left:9} ${txn.formatPrice(item.current_surcharge)|right:10}[&CR]
[&ESC QB]TAL: ${txn.formatPrice(order.total)|right:15}[&CR]
